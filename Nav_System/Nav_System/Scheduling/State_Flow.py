...
end_nodes =["S16","SS4","C10"]
pro_f = ["S9","SS1","S10","SS2"]
#フローグラフ初期化関数
def Create_State_transition_init():
	...
	total_recipe_state_list,first_recipe_state_list,second_recipe_state_list,first_recipe_flow_edges_list,second_recipe_flow_edges_list,cost_time,use_resource,multitasking,third_recipe_state_list,third_recipe_flow_edges_list = RM.Recipe()
	G = nx.DiGraph()
	...
	G.add_nodes_from(third_recipe_state_list)
	G.add_edges_from(third_recipe_flow_edges_list)
	...
	#####ノードに価値をつける
	nx.set_node_attributes(G, name= Reward, values=0)
	####料理iの最終調理作業jの設定######################
	End_Node =end_nodes
